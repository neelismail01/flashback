...
app.get('/home/:id', authenticateToken, (req, res) => {home.homeFeed(req, res, knex)})
...
app.get('/favourites/:id', authenticateToken, (req, res) => {favourites.favouritesFeed(req, res, knex)})
...
app.get('/search/:id', authenticateToken, (req, res) => {search.handleSearch(req, res, knex)})

app.get('/random/:id', authenticateToken, (req, res) => {
    knex('posts')
